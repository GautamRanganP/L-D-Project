...
async function fetchTrainings() {
  ...
  error.value = ''
  try {
    const res = await api.get('https://training-backend-topaz.vercel.app/api/trainings/mine')
...
function downloadReport() {
  ...
  const url = 'https://training-backend-topaz.vercel.app/api/report-excel/mine' // admin export endpoint
