...
async function loadOwners() {
  try {
    const res = await api.get(`${import.meta.env.VITE_API_URL}/api/trainings/owners`) // no params => all trainings
...
function downloadReport() {
  const url = `${import.meta.env.VITE_API_URL}/api/report-excel`
